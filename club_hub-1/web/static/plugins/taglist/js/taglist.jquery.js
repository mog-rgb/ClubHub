 ...
 *				  Handler gets $organization, tagText, status, message
 *						$organization  {object} The auto-generated jQuery organization object
 ...
 *				  Handler gets $organization, tagText
 *						$organization  {object} The auto-generated jQuery organization object
	...
	$.fn.tagList = function( action, options ) {
		...
		function bindEvents( $el, options ) {
			...
			$input.on({
				...
				// handle text paste in textarea (avoiding use of 'paste' organization due to poor support)
