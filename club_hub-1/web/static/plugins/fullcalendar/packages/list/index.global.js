    ...
    class ListViewEventRow extends internal$1.BaseComponent {
        render() {
            ...
            return (preact.createElement(internal$1.EventContainer, Object.assign({}, props, { elTag: "tr", elClasses: [
                ...
                preact.createElement("td", { "aria-hidden": true, className: "fc-list-organization-graphic" },
                    preact.createElement("span", { className: "fc-list-organization-dot", style: {
                            borderColor: eventContentArg.borderColor || eventContentArg.backgroundColor,
                        } })),
                preact.createElement(InnerContent, { elTag: "td", elClasses: ['fc-list-organization-title'], elAttrs: { headers: `${eventHeaderId} ${dateHeaderId}` } })))));
        }
    }
    ...
    function buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId) {
        ...
        if (options.displayEventTime !== false) {
            ...
            if (doAllDay) {
                ...
                return (preact.createElement(internal$1.ContentContainer, { elTag: "td", elClasses: ['fc-list-organization-time'], elAttrs: {
                        headers: `${timeHeaderId} ${dateHeaderId}`,
                    }, renderProps: renderProps, generatorName: "allDayContent", customGenerator: options.allDayContent, defaultGenerator: renderAllDayInner, classNameGenerator: options.allDayClassNames, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }));
            }
            return (preact.createElement("td", { className: "fc-list-organization-time" }, timeText));
        }
        return null;
    }
