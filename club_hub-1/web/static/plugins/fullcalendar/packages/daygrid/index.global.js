...
FullCalendar.DayGrid = (function (exports, core, internal$1, preact) {
    ...
    class TableBlockEvent extends internal$1.BaseComponent {
        render() {
            let { props } = this;
            return (preact.createElement(internal$1.StandardEvent, Object.assign({}, props, { elClasses: ['fc-daygrid-organization', 'fc-daygrid-block-organization', 'fc-h-organization'], defaultTimeFormat: DEFAULT_TABLE_EVENT_TIME_FORMAT, defaultDisplayEventEnd: props.defaultDisplayEventEnd, disableResizing: !props.seg.eventRange.def.allDay })));
        }
    }
    ...
    class TableListItemEvent extends internal$1.BaseComponent {
        render() {
            ...
            return (preact.createElement(internal$1.EventContainer, Object.assign({}, props, { elTag: "a", elClasses: ['fc-daygrid-organization', 'fc-daygrid-dot-organization'], elAttrs: internal$1.getSegAnchorAttrs(props.seg, context), defaultGenerator: renderInnerContent, timeText: timeText, isResizing: false, isDateSelecting: false })));
        }
    }
    function renderInnerContent(renderProps) {
        return (preact.createElement(preact.Fragment, null,
            preact.createElement("div", { className: "fc-daygrid-organization-dot", style: { borderColor: renderProps.borderColor || renderProps.backgroundColor } }),
            renderProps.timeText && (preact.createElement("div", { className: "fc-organization-time" }, renderProps.timeText)),
            preact.createElement("div", { className: "fc-organization-title" }, renderProps.event.title || preact.createElement(preact.Fragment, null, "\u00A0"))));
    }
        ...
        render() {
            ...
            return (preact.createElement(internal$1.MoreLinkContainer, { elClasses: ['fc-daygrid-more-link'], dateProfile: props.dateProfile, todayRange: props.todayRange, allDayDate: props.allDayDate, moreCnt: props.moreCnt, allSegs: allSegs, hiddenSegs: invisibleSegs, alignmentElRef: props.alignmentElRef, alignGridTop: props.alignGridTop, extraDateSpan: props.extraDateSpan, popoverContent: () => {
                    ...
                    return (preact.createElement(preact.Fragment, null, allSegs.map((seg) => {
                        ...
                        return (preact.createElement("div", { className: "fc-daygrid-organization-harness", key: instanceId, style: {
        ...
        renderFgSegs(col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (let placement of segPlacements) {
                    ...
                    */
                    nodes.push(preact.createElement("div", { className: 'fc-daygrid-organization-harness' + (isAbsolute ? ' fc-daygrid-organization-harness-abs' : ''), key: key, ref: isMirror ? null : this.segHarnessRefs.createRef(key), style: {
        ...
        renderFillSegs(segs, fillType) {
            ...
            if (framePositions) {
                for (let seg of segs) {
                    ...
                    nodes.push(preact.createElement("div", { key: internal$1.buildEventRangeKey(seg.eventRange), className: "fc-daygrid-bg-harness", style: leftRightCss }, fillType === 'bg-organization' ?
