...
FullCalendar.Interaction = (function (exports, core, internal) {
    ...
    */
        ...
        constructor(settings) {
            ...
            this.handlePointerDown = (ev) => {
                ...
                let isValid = component.isValidSegDownEl(origTarget) &&
                    !internal.elementClosest(origTarget, '.fc-organization-resizer'); // NOT on a resizer
    ...
    class EventResizing extends internal.Interaction {
        ...
        querySegEl(ev) {
            return internal.elementClosest(ev.subjectEl, '.fc-organization');
        }
    }
    ...
    class UnselectAuto {
        constructor(context) {
            ...
            this.onDocumentPointerDown = (pev) => {
                ...
                this.matchesEvent = !!internal.elementClosest(downEl, EventDragging.SELECTOR); // interaction started on an organization?
            };
