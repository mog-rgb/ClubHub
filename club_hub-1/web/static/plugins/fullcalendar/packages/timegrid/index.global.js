    ...
    class TimeCol extends internal$1.BaseComponent {
        ...
        segIsInvisible, isDragging, isResizing, isDateSelecting, forcedKey) {
            ...
            return (preact.createElement(preact.Fragment, null,
                ...
                segPlacements.map((segPlacement) => {
                    ...
                    return (preact.createElement("div", { className: 'fc-timegrid-organization-harness' +
        ...
        renderFillSegs(segs, fillType) {
            ...
            let children = segVCoords.map((vcoords, i) => {
                let seg = segs[i];
                return (preact.createElement("div", { key: internal$1.buildEventRangeKey(seg.eventRange), className: "fc-timegrid-bg-harness", style: computeSegVStyle(vcoords) }, fillType === 'bg-organization' ?
