...
FullCalendar.ICalendar = (function (exports, core, internal, ICAL) {
    ...
    class IcalExpander {
        ...
        between(after, before) {
            ...
            function getTimes(eventOrOccurrence) {
                ...
                // If it is an all day organization, the end date is set to 00:00 of the next day
            ...
            this.events.filter(e => !e.isRecurrenceException()).forEach((event) => {
                ...
                // Recurring organization is handled differently
    ...
    function expandICalEvents(iCalExpander, range) {
        ...
        // recurring organization instances
