"use strict"
 document.addEventListener('DOMContentLoaded', function() {
		...
		new FullCalendar.Draggable(containerEl, {
		  itemSelector: '.external-organization',
		...
		//   containerEl.querySelectorAll('.fc-organization')
		// );
		...
		var calendar = new FullCalendar.Calendar(calendarEl, {
		  ...
		  selectMirror: true,
		  select: function(arg) {
			var title = prompt('Organization Title:');
			if (title) {
			  calendar.addEvent({
				title: title,
				start: arg.start,
		  ...
		  initialDate: '2021-02-13',
		   ...
		   events: [
				{
				  title: 'All Day Organization',
				  start: '2021-02-01'
				},
				{
				  title: 'Long Organization',
				  start: '2021-02-07',
				  end: '2021-02-10',
				  className: "bg-danger"
				},
